    ...
    public partial class AddtABLE : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "کفش های اسپرت المانی با تنوع ونگ های بسیار عالی", "کفش اسپورت", 200000m },
                    { 2, "کفش های اسپرت المانی با تنوع ونگ های بسیار عالی", " شلوار کتان", 158000m }
                });
